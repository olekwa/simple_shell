...
/**
 * cd_dot - There is a new parent directory.
 *
 * @datash: data pertinent (environ)
 *
 * Return: no return
 */
...
/**
 * cd_to - alterations to a certain directory
 * by the user
 *
 * @datash: data pertinent (directories)
 * Return: no return
 */
...
/**
 * cd_previous - the preceding directory should be changed to
 *
...
/**
 * cd_to_home - switch to the home directory
 *
 * @datash: data pertinent (environ)
 * Return: no return
 */
